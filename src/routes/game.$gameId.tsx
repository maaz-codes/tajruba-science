...
export const Route = createFileRoute("/game/$gameId")({
  head: ({ params }) => ({
    meta: [
      { title: `Game — Tajruba Science` },
      {
        name: "description",
        content: `Play ${params.gameId.replace(/-/g, " ")} — a Tajruba Science learning game.`,
      },
    ],
  }),
  loader: ({ params }) => {
    if (!VALID_GAMES.includes(params.gameId as GameId)) throw notFound();
    return { gameId: params.gameId as GameId };
  },
  component: GamePage,
  notFoundComponent: () => (
    <div className="flex min-h-screen items-center justify-center">
      <div className="text-center">
        <h1 className="text-3xl font-extrabold text-navy">Game not found</h1>
