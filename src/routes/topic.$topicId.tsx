    ...
    meta: [
      {
        title:
          params.topicId === "states-of-matter"
            ? "States of Matter — Tajruba Science"
            : "Topic — Tajruba Science",
      },
      {
        name: "description",
        content:
          "Everything around us is made of tiny bits — solid, liquid, or gas. Play 4 fun games to become a Matter Explorer.",
      },
    ],
  }),
  loader: ({ params }) => {
    if (!(params.topicId in TOPICS)) throw notFound();
    return { topicId: params.topicId as TopicId };
  },
  component: TopicPage,
  notFoundComponent: () => (
    <div className="flex min-h-screen items-center justify-center">
      <div className="text-center">
        <h1 className="text-3xl font-extrabold text-navy">Topic not found</h1>
