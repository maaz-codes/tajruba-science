...
export const FORMATIONS: Formation[] = [
  ...
  [[0, 0]],                                                                   // 1
  [[-0.5, 0], [0.5, 0]],                                                     // 2
  [[0, -0.6], [-0.6, 0.4], [0.6, 0.4]],                                     // 3
  [[-0.5, -0.5], [0.5, -0.5], [-0.5, 0.5], [0.5, 0.5]],                    // 4
  [[0, -0.8], [-0.8, 0], [0.8, 0], [-0.4, 0.8], [0.4, 0.8]],               // 5
  [[-0.6, -0.6], [0.6, -0.6], [-1, 0], [0, 0], [1, 0], [0, 0.8]],         // 6 (adjusted below)
  [[-0.6, -0.8], [0.6, -0.8], [-1, 0], [0, 0], [1, 0], [-0.6, 0.8], [0.6, 0.8]],  // 7
  [[-0.7, -0.7], [0, -0.9], [0.7, -0.7], [-0.9, 0], [0, 0], [0.9, 0], [-0.7, 0.7], [0.7, 0.7]],  // 8
  [[-0.7, -0.7], [0, -0.9], [0.7, -0.7], [-0.9, 0], [0, 0], [0.9, 0], [-0.7, 0.7], [0, 0.9], [0.7, 0.7]], // 9
  [[-0.7, -0.7], [0, -0.9], [0.7, -0.7], [-0.9, 0], [-0.3, 0], [0.3, 0], [0.9, 0], [-0.7, 0.7], [0, 0.9], [0.7, 0.7]], // 10
  [[-0.8, -0.8], [-0.4, -0.8], [0.4, -0.8], [0.8, -0.8], [-1, 0], [-0.4, 0], [0, 0], [0.4, 0], [1, 0], [-0.8, 0.8], [0.8, 0.8]], // 11
  [[-0.8, -0.8], [-0.3, -0.8], [0.3, -0.8], [0.8, -0.8], [-1, 0], [-0.4, 0], [0, 0], [0.4, 0], [1, 0], [-0.8, 0.8], [0, 0.8], [0.8, 0.8]], // 12
];
...
// ── Combination mapping ───────────────────────────────────────────────────────
export const COMBINATIONS: Record<SliderItem, Record<Exclude<MatterState, "empty">, { key: string; label: string }>> = {
  earth: {
